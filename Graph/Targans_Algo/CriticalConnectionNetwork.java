...
class Solution {
    int timer = 1;
    public void DFS(int node, int parent_node, ArrayList<Integer> adjList[], int insertTime[],int lowestInsertionTime[],boolean visited[],List<List<Integer>> bridge){
        //mark visited 
        visited[node] = true;
        ...
        for(int neighbour: adjList[node]){
            ...
            if(visited[neighbour]==false){
                ...
                // if neighbour node is already visited then store the minimum lowest time between
